...
regions = {
    ...
    'Миколаївська область': ['Баштанка', 'Вознесенськ', 'Миколаїв', 'Нова Одеса', 'Новий Буг', 'Очаків', 'Первомайськ',
    ...
    'Львівська область': ['Белз', 'Бібрка', 'Борислав', 'Броди', 'Буськ', 'Великі Мости', 'Винники', 'Глиняни',
